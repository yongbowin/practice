...
def pre_data():
    ...
    # for item in test_list:
        for tweet_item in item['tweet_list_info']:
            ...
            #     x_test_samp_count += 1
                ...
                # if x_test_samp_count > 205:
                #     continue

                rel = tweet_item['relevance']
    ...
    print("====================>", x_train_samp_count + x_test_samp_count)
    print("====================>", x_train_samp_count)
    print("====================>", x_test_samp_count)
    print("====================>", len(tra_list))
    print("====================>", len(tes_list))
